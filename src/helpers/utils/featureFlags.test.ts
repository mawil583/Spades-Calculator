import { getFeatureFlag, setFeatureFlag, FEATURE_FLAGS, FLAG_DEFAULTS } from './featureFlags';
...
describe('featureFlags utilities', () => {
  ...
  it('should return default value when flag is not set', () => {
    expect(getFeatureFlag(FEATURE_FLAGS.TABLE_ROUND_UI)).toBe(FLAG_DEFAULTS[FEATURE_FLAGS.TABLE_ROUND_UI]);
  });
