        ...
        >
          <div>
            ...
            <Container py={10} borderBottom={'1px solid black'}>
              ...
              {/* <div>
                  <h1>
                    {formVals.team1Name} Score: {team1Score}
                  </h1>
                  <h2>
                    {formVals.team1Name} Bags: {team1Bags}
                  </h2>
                </div>
                <div>
                  <h1>
                    {formVals.team2Name} Score: {team2Score}
                  </h1>
                  <h2>
                    {formVals.team2Name} Bags: {team2Bags}
                  </h2>
                </div> */}
            </Container>
