  ...
  return (
    <div className="App">
      ...
      <ul>
        ...
        <li>
          When that information is entered, you are brought to a new screen with
          the Team info at the top as a sticky nav. This means I'll probably
          need to use the Provider API to share state between two different
          componenets. Alternative is to not have a different page, but to just
          update state after team information is entered and have conditional
          redering for "game round" information.
        </li>
        <li>
          Implement Formik (and maybe Yup) for easy form management, and make
          sure I'm not using both Formik form state and local state for the same
          information. Can only have one source of truth!!!
        </li>
      </ul>
      <div>
        <div>
