  ...
  describe("Enhanced Installation Logic", () => {
    ...
    it("should handle errors during installation gracefully", async () => {
      ...
      const originalPrompt = (
        window.Event.prototype as unknown as Record<string, unknown>
      ).prompt;
      (window.Event.prototype as unknown as Record<string, unknown>).prompt = vi
        .fn()
        .mockImplementation(() => {
          throw mockError;
        });
      ...
      (window.Event.prototype as unknown as Record<string, unknown>).prompt =
        originalPrompt;
    });
