...
describe('ErrorModal Component', () => {
  ...
  describe('Modal Interaction', () => {
    ...
    it('should allow editing actuals from within error modal', async () => {
      ...
      renderWithProviders(
        <ErrorModal onOpenModal={mockOnOpenModal}
          isOpen={true}
      ...
      const actualElements = await screen.findAllByText((content) => content.includes('5'));
      const targetElement = actualElements.find(el => el.textContent?.includes('5') || el.textContent === '5');
      ...
      expect(mockOnOpenModal).toHaveBeenCalledWith(expect.objectContaining({
  ...
  describe('Auto-generated tracking in ErrorModal', () => {
    it('should remove asterisk when user manually edits an auto-generated actual', async () => {
      ...
      const actualElements = await screen.findAllByText((content) => content.includes('3') || content.includes('5'));
