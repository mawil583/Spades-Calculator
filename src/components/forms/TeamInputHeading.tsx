    ...
    if (team1CanEdit) {
      if (onOpenModal) {
        onOpenModal({
          ...
          type: 'Actual',
          playerName: 'Team 1',
          onCustomUpdate: (val: InputValue) => handleTeamTotalUpdate(1, val as number),
        });
      } else {
    ...
    if (team2CanEdit) {
      if (onOpenModal) {
        onOpenModal({
          ...
          type: 'Actual',
          playerName: 'Team 2',
          onCustomUpdate: (val: InputValue) => handleTeamTotalUpdate(2, val as number),
        });
      } else {
    ...
    <>
      ...
      {!onOpenModal && (
        <InputModal
          ...
          index={index}
          onCustomUpdate={(value) => handleTeamTotalUpdate(1, value as number)}
        />
      )}
      ...
      {!onOpenModal && (
        <InputModal
          ...
          roundHistory={roundHistory}
          index={index}
          onCustomUpdate={(value) => handleTeamTotalUpdate(2, value as number)}
        />
      )}
